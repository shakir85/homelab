...
module "gha-arc" {
  source                     = "git::https://github.com/shakir85/tf-modules.git//gha-arc?ref=v0.3.2"
...
module "runner-deployment" {
  source           = "git::https://github.com/shakir85/tf-modules.git//gha-runner?ref=v0.3.2"
...
module "gha-roles" {
  source                           = "git::https://github.com/shakir85/tf-modules.git//gha-roles?ref=v0.3.2"
